...
> = ({ boxSize, position, rotate, type = 'solid', layerType }, ref) => {
  ...
  return (
    ...
    >
      {type === 'solid' && layerType !== 'Line' && (layerType as string) !== 'SimpleFrame' && (
        <div
          css={{
      ...
      {type === 'dashed' && layerType !== 'Line' && (layerType as string) !== 'SimpleFrame' && (
        <div
          css={{
            inset: -1,
            position: 'absolute',
